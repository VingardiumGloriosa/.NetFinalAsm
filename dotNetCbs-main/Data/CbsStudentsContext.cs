    ...
    public class CbsStudentsContext : IdentityDbContext
    {
        ...
        private void SeedEvents(ModelBuilder builder)
        {
            builder.Entity<Event>().HasData(
                new Event() { EventId = 4, Title = "No", Description = "fuck me sideways", Date = DateTime.Now },
                new Event() { EventId = 5, Title = "No again", Description = "here is an orgy", Date = DateTime.Now },
                new Event() { EventId = 6, Title = "Noo once more", Description = "woow. sex.", Date = DateTime.Now }
            );
        }
    }
}